...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-3"></div>
      <div class="col-6">
        <form action="issueTraining" method="POST">
          <div class="row mb-3">
            <div class="col-4">
          ...
          <div class="row mb-3">
            <div class="col-4">
              <label for="training_info" class="col-form-label">Training Title/Information</label>
            </div>
            <div class="col-6">
              <input type="text" class="form-control" id="training_info" name="training_info" maxlength="255" size="255"/>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-4">
              <label for="date_start" class="col-form-label">Training Start Date</label>
            </div>
            <div class="col-3">
          ...
          <div class="row mb-5">
            <div class="col-4">
              <label for="date_end" class="col-form-label">Training End Date</label>
            </div>
            <div class="col-3">
