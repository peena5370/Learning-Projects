...
<meta name="viewport" content="width=device-width, initial-scale=1">
  <title>HR Application System - Manager Section</title>
      ...
      <tbody>
        <c:forEach var="employee" items="${viewEmployee}">
          <tr class="fw-light">
            ...
            <td>
              <button type="button" class="btn btn-outline-info btn-sm btn-width-1" onclick="location.href='updateInfo?user=manager&id=${employee.id}&role=employee'">Edit</button>
              <button type="button" class="btn btn-outline-danger btn-sm btn-width-1" onclick="location.href='deleteInfo?user=manager&id=${employee.id}&role=employee'">Delete</button>
            </td>
          </tr>
        </c:forEach>
      </tbody>
