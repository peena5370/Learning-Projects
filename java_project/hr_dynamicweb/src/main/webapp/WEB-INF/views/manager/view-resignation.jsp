...
<meta name="viewport" content="width=device-width, initial-scale=1">
  <title>HR Application System - Employees Resignation List</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="bootstrap-table bootstrap5"  style="margin-left: 5px; margin-right: 5px;">
    <div class="row mb-5 mt-2">
  	  <h3 class="text-center">Employees Resignation List</h3>
    </div>
    <table id="table" data-toggle="table" data-show-columns="true" data-show-columns-toggle-all="true" data-pagination="true" data-search="true" data-search-highlight="true" data-height="620" class="table table-bordered table-hover">
      <thead class="water">
        <tr>
          ...
          <th data-field="enddate">End of Service Date</th>
          <th data-field="employee_name">Employee Name</th>
          <th data-field="approved_by">Approved By</th>
        </tr>
      </thead>
      <tbody>
        <c:forEach var="resignation" items="${viewResignation}">
          <tr class="fw-light">
            <th scope="row" class="fw-normal">${resignation.r_id}</th>
            <td>${resignation.reasons}</td>
            <td>${resignation.enddate}</td>
            <td>${resignation.employee_name}</td>
            <td>${resignation.issuedByManager}</td>
          </tr>
        </c:forEach>
      </tbody>
    </table>
