...
<meta name="viewport" content="width=device-width, initial-scale=1">
  <title>HR Application System - Employees Training List</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="bootstrap-table bootstrap5"  style="margin-left: 5px; margin-right: 5px;">
    <div class="row mb-5 mt-2">
  	  <h3 class="text-center">Employees Training List</h3>
    </div>
    <table id="table" data-toggle="table" data-show-columns="true" data-show-columns-toggle-all="true" data-pagination="true" data-search="true" data-search-highlight="true" data-height="620" class="table table-bordered table-hover">
      <thead class="water">
        <tr>
          ...
          <th data-field="startdate">Date Start</th>
          <th data-field="enddate">Date End</th>
      ...
      <tbody>
        <c:forEach var="training" items="${viewTraining}">
          <tr class="fw-light">
            ...
            <td>
            	<c:choose>
					...
					<img src="./resources/images/completed.png" alt="completed" class="status-btn-2"/>
					</c:when>
					<c:when test="${training.status == 'PENDING'}">
					<img src="./resources/images/pending.png" alt="pending" class="status-btn-2"/>
					</c:when>
					<c:otherwise>
					<p>${training.status}</p>
					</c:otherwise>
