...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-3"></div>
      <div class="col-6">
        <form action="issueResignation" method="POST">
          <div class="row mb-3">
            <div class="col-4">
          ...
          <div class="row mb-3">
            <div class="col-4">
              <label for="date" class="col-form-label">End Of Service Date</label>
            </div>
            <div class="col-3">
          ...
          <div class="row mb-5">
            <div class="col-4">
              <label for="reason" class="col-form-label">Reasons</label>
            </div>
            <div class="col-6">
              <input type="text" class="form-control" id="reason" name="reason" maxlength="255" size="255"/>
            </div>
          </div>
          <div class="row">
