...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
  	<title>HR Application System - Add New Manager Form</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav me-auto mb-2 my-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="admin?addManager">Add Manager</a>
        </li>
        <li class="nav-item">
  ...
  <div class="container-fluid">
      ...
      <h2 class="text-center">Add New Manager Form</h2>
  	</div>
    <div class="row">
      <div class="col-3"></div>
      <div class="col-6">
