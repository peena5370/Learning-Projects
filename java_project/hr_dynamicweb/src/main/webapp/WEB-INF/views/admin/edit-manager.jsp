...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
  	<title>HR Application System - Update Manager Information</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="container-fluid">
    <div class="row mb-5 mt-2">
      <h2 class="text-center">Update Manager Information</h2>
    </div>
    <div class="row">
      <div class="col-3"></div>
      <div class="col-6">
        <form action="updateInfo?user=admin&for=manager" method="POST">
          <div class="row mb-3">
            <div class="col-4">
              <label for="m_fullname" class="col-form-label">Full Name</label>
            </div>
            <div class="col-5">
          ...
          <div class="row mb-3">
            <div class="col-4">
              <label for="m_role" class="col-form-label">Role</label>
            </div>
            <div class="col-3">
              <input type="text" class="form-control" id="m_role" name="m_role"/>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-4">
              <label for="m_department" class="col-form-label">Department</label>
            </div>
            <div class="col-3">
              <input type="text" class="form-control" id="m_department" name="m_department"/>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-4">
              <label for="m_position" class="col-form-label">Position</label>
            </div>
            <div class="col-3">
              <input type="text" class="form-control" id="m_position" name="m_position"/>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-4">
              <label for="m_phone" class="col-form-label">Phone Number</label>
            </div>
            <div class="col-4">
          ...
          <div class="row mb-5">
            <div class="col-4">
              <label for="m_email" class="col-form-label">Email Address</label>
            </div>
            <div class="col-5">
