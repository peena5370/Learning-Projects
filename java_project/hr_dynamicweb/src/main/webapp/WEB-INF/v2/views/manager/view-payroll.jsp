...
<body>
  ...
  <div class="bootstrap-table bootstrap5 container-bg" style="margin: 0 5px 0 5px;">
    <div class="row mb-5 mt-3">
      <h3 class="text-center">Employee Pay-Roll List</h3>
      <hr>
    </div>
    <div class="float-left" style="margin-left: 10px;">
      <button class="btn btn-primary" style="border-radius: 20px;"onclick="openWindow('${pageContext.request.contextPath}/v2/manager/form/issueSalary')">
      <i class="fa fa-plus"></i>&nbsp;&nbsp;Issue Payment
      </button>
    </div>
    ...
    data-height="620">
      <thead class="sky-blue">
        <tr>
          ...
          <th data-field="overtime-pay">Overtime Pay</th>
