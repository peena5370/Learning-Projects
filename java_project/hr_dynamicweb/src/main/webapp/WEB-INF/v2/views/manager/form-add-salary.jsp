...
<body>
  <div class="container form-container">
    ...
    <div class="row px-5">
      <hr>
        <form action="${pageContext.request.contextPath}/v2/manager/form/submit/submitSalary" method="POST">
          <div class="row mb-3">
            <div class="col-12">
  ...
  <script>
		$(window).on('beforeunload', function (e) {
	        e.preventDefault();
	        window.opener.location='${pageContext.request.contextPath}/v2/manager/view-payroll';
    	});
  </script>
</body>
</html>