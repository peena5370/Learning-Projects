...
<body>
  ...
  <div class="bootstrap-table bootstrap5 container-bg"  style="margin: 0 5px 0 5px;">
    <div class="row mb-5 mt-3">
      <h3 class="text-center">Manager Account List</h3>
      <hr>
    </div>
    ...
    data-height="620">
      <thead class="sky-blue">
        <tr>
          ...
          <th data-field="manager-id">Manager ID</th>
          <th data-field="manager-name">Manager Name</th>
      ...
      <tbody>
        <c:forEach var="account" items="${accList2}">
          <tr class="fw-light">
            ...
            <td>
              <button type="button" class="btn btn-outline-info btn-sm" onclick="openWindow('${pageContext.request.contextPath}/v2/admin/form/updateManagerPassword?username=${account.username}'); return false;">Modify</button>
            </td>
          </tr>
        </c:forEach>
      </tbody>
