...
<head>
  ...
  <title>HR Application System - Update Department Form</title>
...
<body>
  <div class="container form-container">
    <div class="row px-3 mt-2">
      <form action="${pageContext.request.contextPath}/v2/admin/form/submit/updateDepartment" method="POST">
        <div class="row mb-3">
          <h3 class="text-center">Update Department Form</h3>
          <hr>
        </div>
        <div class="row mb-3">
