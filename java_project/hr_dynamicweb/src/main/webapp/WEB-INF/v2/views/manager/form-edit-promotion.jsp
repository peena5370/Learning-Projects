...
<head>
  ...
  <title>HR Application System - Promotion Update Form</title>
...
<body>
  <div class="container form-container">
      ...
      <h2 class="text-center">Promotion Update Form</h2>
  	</div>
    <div class="row px-5">
      <hr>
        <form action="${pageContext.request.contextPath}/v2/manager/form/submit/submitUpdatePromotion" method="POST">
          <div class="row mb-3">
            <div class="col-6">
          ...
          <div class="row mb-3">
            <div class="col-6">
              ...
              <input type="text" class="form-control" id="employee-name" name="employee-name" value="${updatePromotion.employeeName}" required/>
            </div>
            <div class="col-6">
              <label for="manager-name" class="col-form-label">Manager Name</label>
              <input type="text" class="form-control" id="manager-name" name="manager-name" value="${updatePromotion.approver}"/>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-6">
              <label for="promote-title" class="col-form-label">Promote Title</label>
              <input type="text" class="form-control" id="promote-title" name="promote-title" value="${updatePromotion.promoteTitle}"/>
            </div>
            <div class="col-3">
              <label for="previous-salary" class="col-form-label">Previous Salary</label>
              <input type="number" class="form-control" id="previous-salary" name="previous-salary" value="${updatePromotion.previousSalary}" min="0" step="any" required/>
            </div>
            <div class="col-3">
              <label for="promote-salary" class="col-form-label">Promote Salary</label>
              <input type="number" class="form-control" id="promote-salary" name="promote-salary" value="${updatePromotion.promoteSalary}" min="0" step="any" required/>
            </div>
          </div>  
          <div class="row mb-3">
            <div class="col-3">
              <label for="promote-date" class="col-form-label">Promote Date</label>
              <input type="date" class="form-control" id="promote-date" name="promote-date" value="${updatePromotion.promoteDate}" required/>
            </div>
          </div>
          <div class="row mb-3">
            <div class="text-center">
              <button type="submit" class="btn btn-primary btn-lg btn-width-2">Update</button>
            </div>
          </div>     
      </form>
    </div>
