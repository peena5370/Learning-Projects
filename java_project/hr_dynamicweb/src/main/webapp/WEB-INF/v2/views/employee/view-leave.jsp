    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav me-auto mb-2 my-lg-0">
		  ...
		  <li class="nav-item">
            <a class="nav-link active" href="${pageContext.request.contextPath}/v2/employee/view-leave">Leave Section</a>
          </li>
          <li class="nav-item">
	  ...
	  <div class="row mb-2">
	  	<div class="col">
	  	  <div class="float-end" style="margin-left: 10px;">
		      <button class="btn btn-dark" style="border-radius: 5px;" onclick="openWindow('${pageContext.request.contextPath}/v2/employee/form/applyLeave?name=${user.fullname}')">
		      Apply Leave
	      	  </button>
          </div>
	  	</div>
