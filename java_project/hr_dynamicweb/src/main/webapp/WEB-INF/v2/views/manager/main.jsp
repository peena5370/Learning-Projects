...
<body>
  ...
  <div class="bootstrap-table bootstrap5 container-bg" style="margin: 0 5px 0 5px;">
    ...
    <div class="float-start" style="margin-left: 10px;">
      <button class="btn btn-primary" style="border-radius: 20px;"onclick="location.href='${pageContext.request.contextPath}/v2/manager/form/addEmployee'">
      ...
      <tbody>
        <c:forEach var="employee" items="${employeeList}">
          <tr class="fw-light">
            ...
            <td>
              <button type="button" class="btn btn-outline-info btn-sm btn-width-1" onclick="location.href='${pageContext.request.contextPath}/v2/manager/form/updateEmployee?id=${employee.id}'">Edit</button>
              <button type="button" class="btn btn-outline-danger btn-sm btn-width-1" onclick="deleteConfirm('${pageContext.request.contextPath}/v2/manager/form/submit/deleteEmployee?id=${employee.id}')">Delete</button>
            </td>
          </tr>
        </c:forEach>
      </tbody>
