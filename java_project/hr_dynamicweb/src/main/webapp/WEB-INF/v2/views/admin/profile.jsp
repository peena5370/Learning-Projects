    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav me-auto mb-2 my-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link d-lg-none d-xl-none d-xxl-none active" href="${pageContext.request.contextPath}/v2/admin/profile?id=${user.id}">Profile</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container container-bg">
    <div class="row">
      <div class="col-12">
        ...
        <!-- Contact detail -->
        <form class="file-upload" action="${pageContext.request.contextPath}/v2/admin/form/submit/submitUpdateProfile" method="POST">
        ...
        <!-- change password -->
        <form class="file-upload" action="${pageContext.request.contextPath}/v2/admin/form/submit/updateProfilePassword?id=${user.id}" method="POST">
          <div class="row mb-5 gx-5">
            <div class="col-xxl-8">
              <div class="bg-secondary-soft px-4 py-5 rounded">
                <div class="row g-3">
