...
<body>
  ...
  <div class="bootstrap-table bootstrap5 container-bg" style="margin: 0 5px 0 5px;">
    <div class="row mb-5 mt-3">
      <h3 class="text-center">Company's Manager List</h3>
      <hr>
    </div>
    <div class="float-left" style="margin-left: 10px;">
      <button class="btn btn-primary" style="border-radius: 20px;" onclick="location.href='${pageContext.request.contextPath}/v2/admin/form/addManager'">
      ...
      <tbody>
        <c:forEach var="manager" items="${managerList}">
          <tr class="fw-light">
            ...
            <td>
              <button type="button" class="btn btn-outline-info btn-sm btn-width-1" onclick="location.href='${pageContext.request.contextPath}/v2/admin/form/updateManager?id=${manager.id}'">Edit</button>
              <button type="button" class="btn btn-outline-danger btn-sm btn-width-1" onclick="deleteConfirm('${pageContext.request.contextPath}/v2/admin/form/submit/deleteManager?id=${manager.id}')">Delete</button>
            </td>
          </tr>
        </c:forEach>
      </tbody>
