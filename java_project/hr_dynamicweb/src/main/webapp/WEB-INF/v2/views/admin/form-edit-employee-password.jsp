...
<body>
  <div class="container form-container">
    <div class="row px-3 mt-2">
      <form action="${pageContext.request.contextPath}/v2/admin/form/submit/updateEmployeePassword" method="POST">
        <div class="row mb-3">
          <h3 class="text-center">Change Employee Password</h3>
          <hr>
        </div>
        <div class="row mb-3">
          <div class="col">
  ...
  <script>
		$(window).on('beforeunload', function (e) {
	        e.preventDefault();
	        window.opener.location='${pageContext.request.contextPath}/v2/admin/view-account-employee';
    	});
  </script>
  <script>
