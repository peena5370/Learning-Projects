...
<body>
  ...
  <div class="bootstrap-table bootstrap5 container-bg" style="margin: 0 5px 0 5px;">
    <div class="row mb-5 mt-3">
      <h3 class="text-center">Employee Loan List</h3>
      <hr>
    </div>
      ...
      <tbody>
        <c:forEach var="loan" items="${loanList}">
          <tr class="fw-light">
            ...
            <td>${loan.approver}</td>
            <td>
              <button type="button" class="btn btn-outline-info btn-sm" onclick="location.href='${pageContext.request.contextPath}/v2/manager/form/submit/updateEmployeeLoan?id=${loan.id}&status=APPROVED&by=${user.fullname}'">Approved</button>
              <button type="button" class="btn btn-outline-danger btn-sm" onclick="location.href='${pageContext.request.contextPath}/v2/manager/form/submit/updateEmployeeLoan?id=${loan.id}&status=REJECTED&by=${user.fullname}'">Rejected</button>
            </td>
          </tr>
        </c:forEach>
      </tbody>
