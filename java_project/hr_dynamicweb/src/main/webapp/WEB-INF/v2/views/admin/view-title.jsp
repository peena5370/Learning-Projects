...
<head>
  ...
  <title>HR Application System - Title Section</title>
...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav me-auto mb-2 my-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="${pageContext.request.contextPath}/v2/admin/view-title">Title Section</a>
          </li>
          <li class="nav-item">
  ...
  <div class="bootstrap-table bootstrap5 container-bg"  style="margin: 0 5px 0 5px;">
    ...
    <div class="float-left" style="margin-left: 10px;">
      <button class="btn btn-primary" style="border-radius: 20px;" onclick="openWindow('${pageContext.request.contextPath}/v2/admin/form/addTitle'); return false;">
    ...
    data-height="620">
      <thead class="sky-blue">
        <tr>
          <th data-field="id">#</th>
          <th data-field="title-name">Title Name</th>
      ...
      <tbody>
        <c:forEach var="title" items="${titleList}">
          <tr class="fw-light">
            <th scope="row" class="fw-normal">${title.id}</th>
            <td>${title.titleName}</td>
            <td>
              <button type="button" class="btn btn-outline-info btn-sm" onclick="openWindow('${pageContext.request.contextPath}/v2/admin/form/updateTitle?id=${title.id}'); return false;">Modify</button>
            </td>
          </tr>
        </c:forEach>
      </tbody>
