...
<body>
  ...
  <div class="bootstrap-table bootstrap5 container-bg" style="margin: 0 5px 0 5px;">
    <div class="row mb-5 mt-3">
      <h3 class="text-center">Company Resignation List</h3>
      <hr>
    </div>
    <div class="float-left" style="margin-left: 10px;">
      <button class="btn btn-primary" style="border-radius: 20px;"onclick="openWindow('${pageContext.request.contextPath}/v2/manager/form/issueResignation')">
      <i class="fa fa-plus"></i>&nbsp;&nbsp;Submit Resign
      </button>
    </div>
