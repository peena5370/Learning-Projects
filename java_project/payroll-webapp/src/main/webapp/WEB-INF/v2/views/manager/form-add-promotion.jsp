      ...
      <nav>
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light">
          <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item">
              <a href="${pageContext.request.contextPath}/manager/promoteEmployee" class="nav-link active" aria-current="page">
        ...
        <section class="col-6 form-container">  
          <form id="promotion-form" action="">
            <div class="row mt-2 px-2">
              <h2>Employee Promotion Form</h2><hr>
            </div>
            <div class="row mb-3">
              <div class="col-6">
            ...
            <div class="row mb-3">
              <div class="text-center">
                <button type="button" class="btn btn-primary btn-lg btn-width-2" onclick="submitAndRedirect('promotion-form', '${pageContext.request.contextPath}/manager/submitPromotion');">Submit</button> 
