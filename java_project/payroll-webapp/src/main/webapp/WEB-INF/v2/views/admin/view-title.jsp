			      ...
			      <tbody>
			        <c:forEach var="title" items="${titleList}">
			          <tr class="fw-light border-bottom">
			            ...
			            <td>
			              <button type="button" class="btn btn-outline-info btn-sm" onclick="openWindow('${pageContext.request.contextPath}/admin/updateTitle?id=${title.id}'); return false;">Modify</button>
			            </td>
			          </tr>
			        </c:forEach>
			      </tbody>
