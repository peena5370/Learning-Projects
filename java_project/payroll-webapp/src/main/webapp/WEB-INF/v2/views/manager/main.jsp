  ...
  <div class="row">
      ...
      <nav>
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light">
          <ul class="nav nav-pills flex-column mb-auto">
            <li class="nav-item">
              <a href="${pageContext.request.contextPath}/manager/main" class="nav-link active" aria-current="page">
    ...
    <div class="col-10">
      ...
      <section class="row bootstrap-table bootstrap5 text-nowrap">
        <div>
          <h3>Company's Employee List</h3><hr>
        </div>
          ...
          <tbody>
            <c:forEach var="employee" items="${employeeList}">
              <tr class="fw-light border-bottom">
                ...
                <td>
                  <button type="button" class="btn btn-outline-info btn-sm btn-width-1" onclick="location.href='${pageContext.request.contextPath}/manager/updateEmployee?id=${employee.id}'">Edit</button>
                  <button type="button" class="btn btn-outline-danger btn-sm btn-width-1" onclick="deleteAlertMsg('${pageContext.request.contextPath}/manager/deleteEmployee?id=${employee.id}')">Delete</button>
                </td>
              </tr>
            </c:forEach>
          </tbody>
