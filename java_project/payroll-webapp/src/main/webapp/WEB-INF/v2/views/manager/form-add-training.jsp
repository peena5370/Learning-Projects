      ...
      <nav>
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light">
          <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
              <a href="${pageContext.request.contextPath}/manager/issueTraining" class="nav-link active" aria-current="page">
                <object type="image/svg+xml" data="${pageContext.request.contextPath}/img/icons/resign-issue.svg" width="16" height="16"></object>
                Issue Training
              </a>
            </li>
      ...
      <div class="row">
        <section class="form-container">
          <form id="training-form">
            <div class="row mt-2">
              <h2>Employee Training Form</h2><hr>
            </div>
            <div class="row mb-3">
              <div class="col-6">
            ...
            <div class="row mb-3">
              <div class="text-center">
                <button type="button" class="btn btn-primary btn-lg btn-width-2" onclick="submitAndRedirect('training-form', '${pageContext.request.contextPath}/manager/submitTraining');">Submit</button>
              </div>
            </div>     
          </form>
        </section>
