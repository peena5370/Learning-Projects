      ...
      <nav>
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light">
          <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
              <a href="${pageContext.request.contextPath}/manager/leavesection" class="nav-link active" aria-current="page">
          ...
          <tbody>
            <c:forEach var="leave" items="${leaveList}">
              ...
              <p>${leave.status}</p>
                ...
                <td>
                  <button type="button" class="btn btn-outline-info btn-sm" onclick="location.href='${pageContext.request.contextPath}/manager/updateEmployeeLeave?id=${leave.id}&status=APPROVED&by=${user.fullname}'">Approved</button>
                  <button type="button" class="btn btn-outline-danger btn-sm" onclick="location.href='${pageContext.request.contextPath}/manager/updateEmployeeLeave?id=${leave.id}&status=REJECTED&by=${user.fullname}'">Rejected</button>
                </td>
              </tr>
            </c:forEach>
          </tbody>
