...
<head>
  ...
  <title>HR Application System - Add Title Form</title>
        ...
        <section class="col-6 form-container">
          <form id="title-form">
            <div class="row mt-2 px-2">
              <h3 class="text-center">Add Title Form</h3><hr>
            </div>
            ...
            <div class="row mb-3">
              <div class="text-center">
                <button type="button" id="submit-btn" class="btn btn-primary btn-lg btn-width-2" onclick="submitAndRedirect('title-form', '${pageContext.request.contextPath}/admin/submitTitle');">Submit</button>
              </div>
            </div>  
          </form>
        </section>
