    ...
    <div class="col-10">
      ...
      <div class="row">
        <section class="col form-container">
          ...
          <!-- Contact detail -->
          <form class="file-upload" action="${pageContext.request.contextPath}/manager/submitUpdateProfile">
          ...
          <!-- change password -->
          <form class="file-upload" action="${pageContext.request.contextPath}/manager/updateProfilePassword">
            <div class="row mb-5 gx-5">
              <div class="col-xxl-8">
                <div class="bg-secondary-soft px-4 py-5 rounded">
                  <div class="row g-3">
