      ...
      <div class="row">
        <section class="form-container">
          <div class="row mt-2 px-2">
            <h2 class="text-center">Add Manager Form</h2><hr>
          </div>
          <div class="row px-5">
            <form id="manager-form">
              ...
              <div class="row mb-3">
                <div class="text-center">
                  <button type="button" class="btn btn-primary btn-lg btn-width-2" onclick="submitAndReload('manager-form', '${pageContext.request.contextPath}/admin/submitManager');">Submit</button> 
