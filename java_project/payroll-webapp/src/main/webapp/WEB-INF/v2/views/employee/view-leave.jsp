...
<div class="container-fluid">
  <div class="row">
      ...
      <nav>
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark">
          ...
          <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
              <a href="${pageContext.request.contextPath}/employee/leave?name=${user.fullname}" class="nav-link active" aria-current="page">
    ...
    <div class="col-9">
      ...
      <section class="row">
        <div class="row">
          <h3>Leave Section</h3><hr>
        </div>
        <div class="row mb-2">
          <div class="col">
            <div class="float-end" style="margin-left: 10px;">
              <button class="btn btn-dark" style="border-radius: 5px;" onclick="openPopUpWindow('${pageContext.request.contextPath}/employee/applyLeave?name=${user.fullname}')">
              Apply Leave
              </button>
            </div>
          </div>
