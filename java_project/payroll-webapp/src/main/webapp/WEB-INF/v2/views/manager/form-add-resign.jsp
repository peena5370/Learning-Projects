  ...
  <div class="row">
      ...
      <nav>
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light">
          <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
              <a href="${pageContext.request.contextPath}/manager/issueResignation" class="nav-link active" aria-current="page">
    ...
    <div class="col-10">
      ...
      <section class="row form-container">
        <form id="resign-form">
          <div class="row mt-2">
            <h2>Employee Resignation Form</h2><hr>
          </div>
          <div class="row mb-3">
            <div class="col-6">
          ...
          <div class="row mb-3">
            <div class="text-center">
              <button type="button" class="btn btn-primary btn-lg btn-width-2" onclick="submitAndRedirect('resign-form', '${pageContext.request.contextPath}/manager/submitResignation');">Submit</button>
            </div>
          </div>     
        </form>
      </section>
