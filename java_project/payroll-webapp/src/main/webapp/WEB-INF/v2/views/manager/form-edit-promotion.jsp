        ...
        <section class="col-6 form-container">
          <form id="promotion-form" action="">
            <div class="row mt-2 px-2">
              <h2>Promotion Update Form</h2><hr>
            </div>
            <div class="row mb-3">
              <div class="col-6">
            ...
            <div class="row mb-3">
              <div class="text-center">
                <button type="button" class="btn btn-primary btn-lg btn-width-2" onclick="submitAndRedirect('promotion-form', '${pageContext.request.contextPath}/manager/submitUpdatePromotion');">Update</button>
              </div>
            </div>
          </form>
        </section>
