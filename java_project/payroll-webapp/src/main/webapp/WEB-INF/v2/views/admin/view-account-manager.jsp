			      ...
			      <tbody>
			        <c:forEach var="account" items="${accList2}">
			          <tr class="fw-light border-bottom">
			            ...
			            <td>
			              <button type="button" class="btn btn-outline-info btn-sm" onclick="openWindow('${pageContext.request.contextPath}/admin/updateManagerPassword?username=${account.username}'); return false;">Modify</button>
			            </td>
			          </tr>
			        </c:forEach>
			      </tbody>
