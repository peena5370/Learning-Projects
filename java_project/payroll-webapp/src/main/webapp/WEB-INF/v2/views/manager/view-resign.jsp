...
<head>
  ...
  <title>HR Application System - Utilities(Resignation Section)</title>
  ...
  <div class="row">
          ...
          <ul class="nav nav-pills flex-column mb-auto">
            <li class="nav-item">
              <a href="${pageContext.request.contextPath}/manager/main" class="nav-link link-dark">
                <object type="image/svg+xml" data="./img/icons/user-group-solid.svg" width="16" height="16"></object>
            ...
            <li class="border-top my-2"></li>
            <li>
              <a href="${pageContext.request.contextPath}/manager/resignsection" class="nav-link active" aria-current="page">
    ...
    <div class="col-10">
      <div class="row">
        ...
        <div>
          <h3>Company Resignation List</h3><hr>
        </div>
        <table id="table" class="table table-responsive table-borderless" 
          ...
          <thead>
            <tr class="border-bottom">
              ...
              <th data-field="resign-date">Resign Date</th>
          ...
          <tbody>
            <c:forEach var="resign" items="${resignList}">
              <tr class="fw-light border-bottom">
                <th scope="row" class="fw-normal">${resign.id}</th>
                <td>${resign.reasons}</td>
                <td>${resign.date}</td>
