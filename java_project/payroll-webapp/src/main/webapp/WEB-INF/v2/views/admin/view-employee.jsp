          ...
          <tbody>
            <c:forEach var="employee" items="${employeeList}">
              <tr class="fw-light border-bottom">
                ...
                <td>
                  <button type="button" class="btn btn-outline-info btn-sm btn-width-1" onclick="location.href='${pageContext.request.contextPath}/admin/updateEmployee?id=${employee.id}'">Edit</button>
                  <button type="button" class="btn btn-outline-danger btn-sm btn-width-1" onclick="deleteAlertMsg('${pageContext.request.contextPath}/admin/deleteEmployee?id=${employee.id}')">Delete</button>
                </td>
              </tr>
            </c:forEach>
          </tbody>
