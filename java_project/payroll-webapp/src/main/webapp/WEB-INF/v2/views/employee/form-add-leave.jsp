...
<div class="container form-container">
  <section class="row px-5">
    <form id="leave-form">
      <div class="row mt-2">
        <h2 class="text-center">Leave Application Form</h2><hr>
      </div>
      <div class="row mb-3">
        <div class="col-6">
      ...
      <div class="row mb-3">
        <div class="text-center">
          <button type="button" class="btn btn-primary btn-lg btn-width-2" onclick="submitAndClose('leave-form', '${pageContext.request.contextPath}/employee/submitLeave');">Submit</button>
        </div>
      </div>     
    </form>
  </section>
...
<script>
  $(window).on('beforeunload', function (e) {
    e.preventDefault();
    window.opener.location='${pageContext.request.contextPath}/employee/leave?name=${user.fullname}';
  });
</script>
</body>
</html>