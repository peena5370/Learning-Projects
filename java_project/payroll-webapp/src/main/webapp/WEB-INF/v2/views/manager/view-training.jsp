  ...
  <div class="row">
      ...
      <nav>
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light">
          <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="border-top my-2"></li>
            <li>
              <a href="${pageContext.request.contextPath}/manager/trainingsection" class="nav-link active" aria-current="page">
    ...
    <div class="col-10">
      <div class="row">
        ...
        <div>
          <h3>Employee Training List</h3><hr>
        </div>
        <table id="table" class="table table-responsive table-borderless" 
          ...
          <tbody>
            <c:forEach var="training" items="${trainingList}">
              ...
              <img src="${pageContext.request.contextPath}/img/completed.png" alt="completed" class="status-btn-2"/>
              </c:when>
              <c:when test="${training.status == 'PENDING'}">
              <img src="${pageContext.request.contextPath}/img/pending.png" alt="pending" class="status-btn-2"/>
              </c:when>
              <c:otherwise>
              <p>${training.status}</p>
              </c:otherwise>
