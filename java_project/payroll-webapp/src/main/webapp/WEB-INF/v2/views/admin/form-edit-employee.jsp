          ...
          <form id="employee-form">
            ...
            <div class="row mb-3">
              ...
              <div class="col-2">
                ...
                <input type="number" class="form-control" id="age" name="age" value="${updateEmployee.age}" min="18" max="99" required/>
              </div>
              <div class="col-2">
            ...
            <div class="row mb-3">
              <div class="text-center">
                <button type="button" class="btn btn-primary btn-lg btn-width-2" onclick="submitAndRedirect('employee-form', '${pageContext.request.contextPath}/admin/submitUpdateEmployee');">Submit</button> 
