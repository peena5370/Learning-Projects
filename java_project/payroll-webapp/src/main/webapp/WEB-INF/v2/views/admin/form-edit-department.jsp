...
<head>
  ...
  <title>HR Application System - Update Department Information</title>
        ...
        <section class="col-6 form-container">
          <form id="dept-form">
            <div class="row mt-2 px-2">
              <h3 class="text-center">Update Department Form</h3><hr>
            </div>
            ...
            <div class="text-center">
              <button type="button" class="btn btn-primary btn-lg btn-width-2" onclick="submitAndRedirect('dept-form', '${pageContext.request.contextPath}/admin/submitUpdateDepartment');">Submit</button>
            </div>
          </div>  
        </form>
      </section>
