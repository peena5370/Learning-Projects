  ...
  <div class="row">
      ...
      <nav>
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light">
          <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item">
              <a href="${pageContext.request.contextPath}/manager/promotionsection" class="nav-link active" aria-current="page">
    ...
    <div class="col-10">
      <div class="row">
        ...
        <div>
          <h3>Employee Promotion List</h3><hr>
        </div>
          ...
          <tbody>
            <c:forEach var="promotion" items="${promotionList}">
              <tr class="fw-light border-bottom">
                ...
                <td>
                  <button type="button" class="btn btn-outline-info btn-sm" onclick="openWindow('${pageContext.request.contextPath}/manager/updatePromotion?id=${promotion.id}')">Update</button>
                </td>
              </tr>
            </c:forEach>
          </tbody>
