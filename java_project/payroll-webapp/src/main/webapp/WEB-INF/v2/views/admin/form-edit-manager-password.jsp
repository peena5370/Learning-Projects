        ...
        <section class="col-6 form-container">
          <form id="password-form">
            <div class="row mt-2 px-2">
              <h3 class="text-center">Change Manager Password</h3><hr>
            </div>
            <div class="row mb-3">
              <div class="col">
            ...
            <div class="row mb-3">
              ...
              <div class="row mb-3">
                <div class="text-center">
                  <button type="button" class="btn btn-primary btn-lg btn-width-2" onclick="submitAndRedirect('password-form', '${pageContext.request.contextPath}/admin/submitManagerPassword');">Submit</button> 
