    ...
    <div class="col-2">
      ...
      <section class="row">
        <div class="bootstrap-table bootstrap5"  style="margin: 0 5px 0 5px;">
          <div class="row">
            <h3>Employee Account List</h3><hr>
          </div>
            ...
            <tbody>
              <c:forEach var="account" items="${accList}">
                <tr class="fw-light border-bottom">
                  ...
                  <td>
                    <button type="button" class="btn btn-outline-info btn-sm" onclick="openWindow('${pageContext.request.contextPath}/admin/updateEmployeePassword?username=${account.username}'); return false;">Modify</button>
                  </td>
                </tr>
              </c:forEach>
            </tbody>
