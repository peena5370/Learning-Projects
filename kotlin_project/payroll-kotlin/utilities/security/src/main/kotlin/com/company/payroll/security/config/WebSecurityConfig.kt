...
import com.company.payroll.security.impl.UserAccountServiceImpl
                        ...
                        @Autowired private val userAccountServiceImpl: UserAccountServiceImpl)
{
    ...
    {
        auth.userDetailsService<UserDetailsService>(userAccountServiceImpl)
...
//        authorize(anyRequest, authenticated)
    ...
    fun corsConfigurationSource(): CorsConfigurationSource
    {
        ...
        configuration.allowedOrigins =
            listOf("http://localhost:8000", "http://localhost:8080", "http://localhost:8081", "http://localhost:9000")
