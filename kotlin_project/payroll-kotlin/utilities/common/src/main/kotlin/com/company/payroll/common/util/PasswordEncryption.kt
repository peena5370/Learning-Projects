...
class PasswordEncryption
{
    ...
    {
        val pbkdf2PasswordEncoder = Pbkdf2PasswordEncoder(secretKey, defaultSaltLength, defaultIterations, skfa)
    ...
    {
        val sCryptPasswordEncoder = SCryptPasswordEncoder(defaultProcessorCost,
                                                          defaultRamCost,
                                                          parallelization,
                                                          defaultKeyLength,
                                                          defaultSaltLength)
